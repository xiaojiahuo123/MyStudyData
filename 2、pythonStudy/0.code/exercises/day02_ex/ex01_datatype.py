...
# 完成以下转换，观察结果
print("--- int() ---")
print(int("123"))        # 字符串转整数: ____
print(int("12", 16))    # 十六进制字符串转整数: ____
print(int(3.99))         # 浮点数转整数: ____ (注意截断方式)
print(int(-3.99))        # 负浮点数转整数: ____
print(int(True))         # 布尔转整数: ____

print("--- float() ---")
print(float("3.14"))     # ____
print(float("inf"))      # ____
print(float("-inf"))     # ____
print(float("nan"))      # ____
print(float(True))       # ____
...
print(bool(-1))          # ____
print(bool(""))          # ____
print(bool("0"))         # ____  注意! "0" 是非空字符串
print(bool([]))          # ____
print(bool([0]))         # ____  注意! [0] 是非空列表
print(bool(None))        # ____
...
# 以下哪些比较会出问题？
print(f"0.1 + 0.2 == 0.3:        {0.1 + 0.2 == 0.3}")         # ____
print(f"0.1 + 0.2 - 0.3 == 0.0:  {0.1 + 0.2 - 0.3 == 0.0}")  # ____
...
print(f"True + True: {True + True}")         # ____
print(f"True * 10: {True * 10}")              # ____
print(f"False + 100: {False + 100}")          # ____
print(f"True > False: {True > False}")        # ____
...
d = Dog()
print(f"type(d) == Dog:     {type(d) == Dog}")         # ____
print(f"type(d) == Animal:  {type(d) == Animal}")      # ____
print(f"isinstance(d, Dog):    {isinstance(d, Dog)}")  # ____
print(f"isinstance(d, Animal): {isinstance(d, Animal)}") # ____
